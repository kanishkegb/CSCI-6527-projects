...
Below is a gallery of autostereograms developed. If you can't recognize any of the autostereograms or want to see the originals, check this [page]().
...
One another cool feature we can implement with this techniques is a moving autostereogram. Basically depth map we choose must be a function of time. We generate the autostereogram for each frame and combine them into a single sequence of images, as a gif or a video. Below is an image

<!-- <div align="center">
  <a href="Project-3/images/vid.mp4"><img src="https://img.youtube.com/vi/KlSysxmtJnU/0.jpg" alt="Video demo of ConvNet (CNN) generated depth maps using "monodepth" github code" width="800"></a>
</div> -->

<iframe width="560" height="315" src="https://www.youtube.com/embed/KlSysxmtJnU?start=42" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>


<!-- <div align="center">
  <a href="https://www.youtube.com/watch?v=KlSysxmtJnU?t=42s"><img src="https://img.youtube.com/vi/KlSysxmtJnU/0.jpg" alt="Video demo of ConvNet (CNN) generated depth maps using "monodepth" github code" width="800"></a>
</div> -->
