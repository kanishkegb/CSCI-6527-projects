...
# Define variables
PATH_TO_CKPT = os.path.join('output_inference_graph.pb', 'frozen_inference_graph.pb')
...
for image_path in TEST_IMAGE_PATHS:
  ...
  Image.fromarray(image_np).save('predicted_test_images/{}'.format(image_path[-12:]),
  ...
  if output_dict['detection_scores'][0] > 0.5:
    ...
    cropped_im.save('cropped_test_images/{}'.format(image_path[-12:]), 'JPEG',
